...
// 	protoc        v7.35.1
// source: internal/kpl/messages.proto
...
func (x *AggregatedRecord) Reset() {
	*x = AggregatedRecord{}
	mi := &file_internal_kpl_messages_proto_msgTypes[0]
...
func (x *Record) Reset() {
	*x = Record{}
	mi := &file_internal_kpl_messages_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_internal_kpl_messages_proto protoreflect.FileDescriptor

const file_internal_kpl_messages_proto_rawDesc = "" +
	"\n" +
	"\x1binternal/kpl/messages.proto\x12\bproducer\"n\n" +
	...
	"\x04data\x18\x03 \x01(\fB\x05\xaa\x01\x02\b\x03R\x04dataB\x10Z\x0e./internal/kplb\beditionsp\xe9\a"

var file_internal_kpl_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_internal_kpl_messages_proto_goTypes = []any{
	(*AggregatedRecord)(nil), // 0: producer.AggregatedRecord
	(*Record)(nil),           // 1: producer.Record
}
var file_internal_kpl_messages_proto_depIdxs = []int32{
...
func init() { file_internal_kpl_messages_proto_init() }
func file_internal_kpl_messages_proto_init() {
	if File_internal_kpl_messages_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_kpl_messages_proto_rawDesc), len(file_internal_kpl_messages_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_internal_kpl_messages_proto_goTypes,
		DependencyIndexes: file_internal_kpl_messages_proto_depIdxs,
		MessageInfos:      file_internal_kpl_messages_proto_msgTypes,
	}.Build()
	File_internal_kpl_messages_proto = out.File
	file_internal_kpl_messages_proto_goTypes = nil
	file_internal_kpl_messages_proto_depIdxs = nil
}
